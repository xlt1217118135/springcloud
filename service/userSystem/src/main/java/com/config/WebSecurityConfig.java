...
//                .and()
//                .authorizeRequests()
//                .antMatchers(HttpMethod.GET, "/test/test").permitAll() //此处存放不拦截的方法请求
...
//        auth.userDetailsService(redefinedUserDetailService).passwordEncoder(new BCryptPasswordEncoder());
//    }
//
//
//}
